...
VL_ATTR_COLD void Vtb_mux4to1___024root___eval_initial__TOP(Vtb_mux4to1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_mux4to1___024root___eval_initial__TOP\n"); );
    ...
    __Vtemp_1[1U] = 0x34746f31U;
    __Vtemp_1[2U] = 0x5f6d7578U;
...
VL_ATTR_COLD void Vtb_mux4to1___024root___eval_triggers__stl(Vtb_mux4to1___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_mux4to1___024root___eval_triggers__stl\n"); );
    Vtb_mux4to1__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
